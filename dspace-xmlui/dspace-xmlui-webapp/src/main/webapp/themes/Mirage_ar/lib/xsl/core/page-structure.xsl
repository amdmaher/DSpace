            ...
            <xsl:choose>
              <xsl:when test="/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='framing'][@qualifier='popup']">
                <xsl:apply-templates select="dri:body/*"/>
                 ...
                 <xsl:variable name="last-string" select="concat(substring-before(/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='request'][@qualifier='URI'], '/item'),'/item')"/>
                ...
                <xsl:variable name="context-str" select="/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='contextPath'][not(@qualifier)]" />
          
                   
                    <xsl:choose>
          <xsl:when test="contains($query-string, 'locale-attribute') ">

          <xsl:variable name="query-string" select="substring-before($query-string, 'locale-attribute')"/>  
          
    <div style="margin-left:500px;float:left;direction:rtl"> لغة الشاشة  ::  <a href="?{$query-string}locale-attribute=ar"> العربية </a> | <a href="?{$query-string}locale-attribute=en"> English </a> </div>
         <div style="margin-right:300px;direction:rtl"> اتجاه الشاشة :: <a href="/xmlui?locale-attribute=ar"> العربية </a> | <a href="/en?locale-attribute=en"> English </a> </div>
         ...
         <div style="margin-right:300px;direction:rtl">اتجاه الشاشة  :: <a href="/xmlui?locale-attribute=ar"> العربية </a> | <a href="/en?locale-attribute=en"> English </a> </div>
             ...
             <!--       <div style="padding-left:600px;"> <a href="?{$query-string}&amp;locale-attribute=ar&amp;themepath=Mirage/"> العربية </a> | <a href="?{$query-string}&amp;locale-attribute=en&amp;themepath=Mirage-en/"> English </a> </div> -->
        ...
        <div id="ds-header-wrapper">
            <div id="ds-header" class="clearfix">
                <a id="ds-header-logo-link">
                    ...
                    <span id="ds-header-logo-text">ميراج العربي </span>
                </a>
        ...
        <div id="ds-footer-wrapper">
            <div id="ds-footer">
                <div id="ds-footer-right">
                     تركيب وتعريب و استضافة : مؤسسة تقنية المعارف
                     <br /> الرياض / المملكة العربية السعودية
                   <br />   ت 00966505307267
                   <br />  email : massoud@kwareict.com 
                  <br />   برمجيات  دي سبيس - كود مفتوح المصدر
<br />  حقوق النسخ محفوظة 2002-2011  دوراسبيس
<br />  ثيم الميراج - مساهمة من قبل @MIRE

                </div>
             
             <div id="ds-footer-left"> 
<span class="theme-by">  </span> 
 <div align="center" >  <img src="/xmlui/themes/Mirage/images/DSpace-logo.png" /> <img src="/xmlui/themes/Mirage/images/DuraSpace-logo.png"/> <img src="/xmlui/themes/Mirage/images/AtMIRElogo.png" /> <img src="/xmlui/themes/Mirage/images/Kware.png" /> </div>
</div> 
